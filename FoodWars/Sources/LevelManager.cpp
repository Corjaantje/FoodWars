...
LevelManager::LevelManager() : _entityManager(), _gameLevel(nullptr) {
...
void LevelManager::generateTerrainDrawables(int x, int y) {
    ...
    _entityManager.addComponentToEntity(terrain, DamageableComponent{1});
    _entityManager.addComponentToEntity(terrain, BoxCollider{32, 32});
    _entityManager.addComponentToEntity(terrain, PositionComponent(x, y));
}
...
void LevelManager::spawnPlayers(){
    ...
    AnimationComponent animationComponent{spawnAnimation, 0.1};
    ...
    AnimationComponent animationComponent2{spawnAnimation2, 0.1};
    ...
    entityManager->addComponentToEntity(player, DrawableComponent{});
    entityManager->addComponentToEntity(player, BoxCollider(48, 72));
    entityManager->addComponentToEntity(player, PositionComponent(spawnPoint1.getXCoord(), spawnPoint1.getYCoord()));
    entityManager->addComponentToEntity(player, turnComponent);
    entityManager->addComponentToEntity(player, MoveComponent{});
    entityManager->addComponentToEntity(player, GravityComponent());
    entityManager->addComponentToEntity(player, animationComponent);
    entityManager->addComponentToEntity(player, DamageableComponent{});

    // Player
    player = entityManager->createEntity();
    entityManager->addComponentToEntity(player, DrawableComponent{});
    entityManager->addComponentToEntity(player, BoxCollider(48, 72));
    entityManager->addComponentToEntity(player, PositionComponent(spawnPoint2.getXCoord(), spawnPoint2.getYCoord()));
    entityManager->addComponentToEntity(player, TurnComponent{});
    entityManager->addComponentToEntity(player, MoveComponent{});
    entityManager->addComponentToEntity(player, GravityComponent());
    ...
    entityManager->addComponentToEntity(boundLeft, BoxCollider(900, 900));
    entityManager->addComponentToEntity(boundLeft, PositionComponent(-900, 0));

    int boundRight = entityManager->createEntity();
    entityManager->addComponentToEntity(boundRight, BoxCollider(900, 900));
    entityManager->addComponentToEntity(boundRight, PositionComponent(1600, 0));

    int boundBottom = entityManager->createEntity();
    entityManager->addComponentToEntity(boundBottom, BoxCollider(1600, 1600));
    entityManager->addComponentToEntity(boundBottom, PositionComponent(0, 900));
}