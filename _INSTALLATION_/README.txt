...
12.Select the 3 folders in the SDL2_mixer folder (depending on if your OS is 32bit or 64bit) and copy them over to C:\MinGW
12.Select the 3 folders in the SDL2_ttf folder (depending on if your OS is 32bit or 64bit) and copy them over to C:\MinGW to merge their contents.
